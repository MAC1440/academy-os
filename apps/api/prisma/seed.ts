...
const permissions = [
  ...
  ['website.read', 'Website', 'View website settings and previews'],
  ['website.manage', 'Website', 'Manage website draft settings'],
  ['website.publish', 'Website', 'Publish website changes'],
